...
export const questions = [
  {type:"mcq",question:"गृहम् means:",instruction:"गृहम् शब्दका अनुवाद करें।",options:["Village","Market","Home घर","School"],answer:"Home घर",explanation:"गृहम् = Home (घर). Cognate with English 'hovel' and Greek 'choira' — all from the same Indo-European root."},
  ...
  {type:"mcq",question:"अहं गृहं गच्छामि। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["I go to the market","I go home — मैं घर जाता हूँ","He goes home","You go to school"],answer:"I go home — मैं घर जाता हूँ",explanation:"अहं गृहं गच्छामि = I go home (मैं घर जाता हूँ). The -म् ending of गृहम् softens to -ं to show destination."},
  ...
  {type:"mcq",question:"त्वं पाठशालां गच्छसि किम्। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["You go to school","Do you go to school? — क्या तुम पाठशाला जाते हो?","Does he go to school?","Where do you go?"],answer:"Do you go to school? — क्या तुम पाठशाला जाते हो?",explanation:"त्वं पाठशालां गच्छसि किम् = Do you go to school? (क्या तुम पाठशाला जाते हो?) — किम् at the end makes it a yes/no question."},
