...
export const questions = [
  {type:"mcq",question:"त्वं कुत्र गच्छसि। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["You go home","Where do you go? — तुम कहाँ जाते हो?","Who goes there?","Do you go?"],answer:"Where do you go? — तुम कहाँ जाते हो?",explanation:"त्वं कुत्र गच्छसि = Where do you go? (तुम कहाँ जाते हो?) — कुत्र asks for a location answer."},
  {type:"mcq",question:"किं त्वम् आपणं गच्छसि। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["You go to the market","Do you go to the market? — क्या तुम बाज़ार जाते हो?","He goes to the market","Where is the market?"],answer:"Do you go to the market? — क्या तुम बाज़ार जाते हो?",explanation:"किं त्वम् आपणं गच्छसि = Do you go to the market? (क्या तुम बाज़ार जाते हो?) — किम् turns it into a yes/no question."},
  ...
  {type:"mcq",question:"Where in the sentence can किम् appear for a yes/no question?",instruction:"किम्के स्थान संबंधी नियम चुनें।",options:["Only in the middle","Start or end — both work","Always at the end only","Always at the start only"],answer:"Start or end — both work",explanation:"किम् is flexible: किं सः गच्छति (start) and सः गच्छति किम् (end) both mean 'Does he go?' Sanskrit word order is freer than English."},
