...
export const briefing = {
  pre: {
    ...
    sections: [
      ...
      { type:"grammar", label:"WHO + PLACE // कः", text:"<strong>कः</strong> + place + verb = 'Who goes to ___?'<br>कः आपणं गच्छति — Who goes to the market?<br>कः पाठशालां गच्छति — Who goes to school?" },
...
export const questions = [
  ...
  {type:"fill",question:"Add the question particle to make this a yes/no question: सः उद्यानं गच्छति ___",sentenceParts:["सः उद्यानं गच्छति ",""],answer:"किम्",answerRoman:"kim",explanation:"सः उद्यानं गच्छति किम् = Does he go to the garden? — किम् at the end makes it a yes/no question."},
  {type:"wordtiles",question:"Build: 'Does he go to the village?'",tiles:["किं","सः","ग्रामं","गच्छति"],distractors:["न","तत्र"],answer:"किं सः ग्रामं गच्छति",explanation:"किं सः ग्रामं गच्छति = Does he go to the village? — किम् at the start, then subject + destination + verb."},
  ...
  {type:"translation",question:"Type: 'Where does he go?' (use कुत्र)",hint:"Pronoun सः + question word + verb",answer:"सः कुत्र गच्छति",answerRoman:"saH kutra gacchati",explanation:"सः कुत्र गच्छति = Where does he go? (वह कहाँ जाता है?) — कुत्र sits between the subject and verb."}
];
