...
export const questions = [
  ...
  {type:"mcq",question:"कः आपणं गच्छति। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["Does he go to the market?","Where do you go?","Who goes to the market? — बाज़ार कौन जाता है?","He does not go to the market"],answer:"Who goes to the market? — बाज़ार कौन जाता है?",explanation:"कः = Who? (कौन). कः आपणं गच्छति = Who goes to the market? (बाज़ार कौन जाता है?)"},
  ...
  {type:"mcq",question:"यत्र त्वं गच्छसि तत्र अहं गच्छामि। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["Where you go, I go there too — जहाँ तुम जाते हो वहाँ मैं जाता हूँ","I go where he goes","Where does he go?","You do not go anywhere"],answer:"Where you go, I go there too — जहाँ तुम जाते हो वहाँ मैं जाता हूँ",explanation:"यत्र = where (जहाँ), तत्र = there (वहाँ). यत्र...तत्र links two clauses: where you go, there I go."},
  ...
  {type:"mcq",question:"Which verb goes with अहं?",instruction:"अहं के साथ प्रयुक्त क्रिया-रूप चुनें।",options:["गच्छति","गच्छसि","गच्छामि","गच्छन्ति"],answer:"गच्छामि",explanation:"अहं गच्छामि = I go. The -आमि ending is the first-person singular. त्वं गच्छसि (you go), सः गच्छति (he goes)."},
