...
export const questions = [
  {type:"mcq",question:"सः ग्रामं न गच्छति किम्। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["He goes to the village","He does not go to the village","Does he not go to the village? — क्या वह गाँव नहीं जाता?","Where does he not go?"],answer:"Does he not go to the village? — क्या वह गाँव नहीं जाता?",explanation:"न + किम् together make a negative yes/no question. सः ग्रामं न गच्छति = he does not go; adding किम् turns it into: Does he not go to the village?"},
  ...
  {type:"mcq",question:"कः पाठशालां न गच्छति। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["He does not go to school","Who does not go to school? — पाठशाला कौन नहीं जाता?","Does he not go to school?","You do not go to school"],answer:"Who does not go to school? — पाठशाला कौन नहीं जाता?",explanation:"कः = Who? (कौन). Adding न makes it negative: कः पाठशालां न गच्छति = Who does not go to school?"},
  {type:"mcq",question:"सः कुत्र न गच्छति। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["He does not go","Where does he not go? — वह कहाँ नहीं जाता?","He goes where you go","Does he not go?"],answer:"Where does he not go? — वह कहाँ नहीं जाता?",explanation:"कुत्र + न together in the same sentence: सः कुत्र न गच्छति = Where does he not go? (वह कहाँ नहीं जाता?)"},
