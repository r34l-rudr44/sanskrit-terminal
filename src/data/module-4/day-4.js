...
export const questions = [
  {type:"mcq",question:"\"इको यणचि\" means:",instruction:"इस सूत्रका अर्थ चुनें।",options:["Similar vowels fuse into a long vowel","अ/आ upgrades the following vowel","ik vowels (इ/ई, उ/ऊ, ऋ) become semi-vowels before a different vowel — इक् स्वर यण् बन जाते हैं","Vowels disappear after consonants"],answer:"ik vowels (इ/ई, उ/ऊ, ऋ) become semi-vowels before a different vowel — इक् स्वर यण् बन जाते हैं",explanation:"इकः = of the ik vowels (इ/ई, उ/ऊ, ऋ); यण् = the semi-vowels (य्, व्, र्); अचि = before a vowel. When ik vowels precede any different vowel, they shift to the corresponding semi-vowel."},
  {type:"mcq",question:"इ / ई + (different vowel) = ?",instruction:"इ/ई + (भिन्न स्वर) का सन्धि परिणाम चुनें।",options:["य् + that vowel","व् + that vowel","र् + that vowel","ए"],answer:"य् + that vowel",explanation:"इ or ई before a different vowel becomes य् (the palatal semi-vowel) by यण सन्धि. Example: यदि + अपि → यद् + य् + अपि = यद्यपि."},
  {type:"mcq",question:"यदि + अपि = ?",instruction:"यदि + अपिका सन्धि रूप चुनें।",options:["यदिअपि","यदेऽपि","यद्यपि","यदिपि"],answer:"यद्यपि",explanation:"यदि ends in इ; अपि begins with a different vowel अ. इ → य् before अ: यद् + य् + अपि = यद्यपि (although / यद्यपि)."},
  {type:"mcq",question:"उ / ऊ + (different vowel) = ?",instruction:"उ/ऊ + (भिन्न स्वर) का सन्धि परिणाम चुनें।",options:["य् + that vowel","व् + that vowel","र् + that vowel","ओ"],answer:"व् + that vowel",explanation:"उ or ऊ before a different vowel becomes व् (the labial semi-vowel) by यण सन्धि. Example: गुरु + आश्रम → गुर् + व् + आश्रम = गुर्वाश्रम."},
  ...
  {type:"mcq",question:"इति + अत्र = ?",instruction:"इति + अत्रका सन्धि रूप चुनें।",options:["इत्यत्र","इत्यात्र","इतिअत्र","इतेऽत्र"],answer:"इत्यत्र",explanation:"इति ends in इ; अत्र begins with अ (different vowel). इ → य् before अ: इत् + य् + अत्र = इत्यत्र (thus here)."},
