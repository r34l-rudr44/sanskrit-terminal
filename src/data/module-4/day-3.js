...
export const questions = [
  {type:"mcq",question:"\"वृद्धिरेचि\" means:",instruction:"इस सूत्रका अर्थ चुनें।",options:["Two similar vowels fuse into a long vowel","अ/आ upgrades ए/ऐ or ओ/औ into a vṛddhi vowel — ऐ or औ","अ/आ combines with इ or उ to form ए or ओ","Vowels disappear before consonants"],answer:"अ/आ upgrades ए/ऐ or ओ/औ into a vṛddhi vowel — ऐ or औ",explanation:"वृद्धि = 'growth'; एचि = before ec vowels (ए, ओ, ऐ, औ). When अ/आ precedes these vowels, the pair rises to ऐ or औ — the 'grown' forms."},
  {type:"mcq",question:"अ + ए = ?",instruction:"अ + ए का सन्धि परिणाम चुनें।",options:["ऐ","ओ","ए","औ"],answer:"ऐ",explanation:"अ + ए → ऐ by वृद्धि सन्धि. Example: एक (अ) + एक (ए) = एकैक. The boundary अ+ए rises to ऐ."},
  {type:"mcq",question:"एक + एक = ?",instruction:"एक + एकका सन्धि रूप चुनें।",options:["एकेक","एकएक","एकोक","एकैक"],answer:"एकैक",explanation:"एक ends in अ; the second एक begins with ए. अ + ए → ऐ: the boundary rises to ऐ, giving एकैक (one by one)."},
  {type:"mcq",question:"अ + ओ = ?",instruction:"अ + ओ का सन्धि परिणाम चुनें।",options:["ओ","ऐ","औ","ए"],answer:"औ",explanation:"अ + ओ → औ by वृद्धि सन्धि. Example: महा (आ) + ओषधि (ओ) → आ+ओ → औ → महौषधि."},
  {type:"mcq",question:"महा + ओषधि = ?",instruction:"महा + ओषधिका सन्धि रूप चुनें।",options:["महेषधि","महाओषधि","महौषधि","महोषधि"],answer:"महौषधि",explanation:"महा ends in आ; ओषधि begins with ओ. आ + ओ → औ: the boundary rises to औ, giving महौषधि (great medicine)."},
