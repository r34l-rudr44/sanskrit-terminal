...
export const questions = [
  {type:"mcq",question:"\"आदगुणः\" means:",instruction:"इस सूत्रका अर्थ चुनें।",options:["Two similar vowels fuse into one long vowel","अ/आ combines with इ, उ, or ऋ to produce a guṇa vowel — अ/आ से गुण स्वर बनता है","A vowel disappears at word boundaries","Two consonants merge"],answer:"अ/आ combines with इ, उ, or ऋ to produce a guṇa vowel — अ/आ से गुण स्वर बनता है",explanation:"आद् = from आ/अ; गुणः = guṇa vowel. When अ or आ precedes इ/ई, उ/ऊ, or ऋ, both upgrade to the corresponding guṇa vowel: ए, ओ, or अर्."},
  {type:"mcq",question:"अ + इ = ?",instruction:"अ + इ का सन्धि परिणाम चुनें।",options:["ऐ","आ","ए","ओ"],answer:"ए",explanation:"अ + इ → ए by गुण सन्धि. Example: देव (ends in अ) + इन्द्र (starts with इ) = देवेन्द्र. The boundary अ+इ upgrades to ए."},
  {type:"mcq",question:"देव + इन्द्र = ?",instruction:"देव + इन्द्रका सन्धि रूप चुनें।",options:["देवइन्द्र","देवैन्द्र","देवेन्द्र","देवोन्द्र"],answer:"देवेन्द्र",explanation:"देव ends in अ; इन्द्र begins with इ. अ + इ → ए: the boundary upgrades to ए, giving देवेन्द्र (Lord of gods / Devendra)."},
  {type:"mcq",question:"अ + उ = ?",instruction:"अ + उ का सन्धि परिणाम चुनें।",options:["ओ","ए","औ","ऊ"],answer:"ओ",explanation:"अ + उ → ओ by गुण सन्धि. Example: सूर्य (ends in अ) + उदय (starts with उ) = सूर्योदय. The boundary अ+उ upgrades to ओ."},
  {type:"mcq",question:"सूर्य + उदय = ?",instruction:"सूर्य + उदयका सन्धि रूप चुनें।",options:["सूर्युदय","सूर्यौदय","सूर्योदय","सूर्यादय"],answer:"सूर्योदय",explanation:"सूर्य ends in अ; उदय begins with उ. अ + उ → ओ: the boundary upgrades to ओ, giving सूर्योदय (sunrise)."},
