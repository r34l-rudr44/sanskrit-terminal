...
export const questions = [
  {type:"mcq",question:"\"एचोऽयवायावः\" means:",instruction:"इस सूत्रका अर्थ चुनें।",options:["Two similar vowels fuse into one long vowel","ec vowels (ए, ओ, ऐ, औ) dissolve into अय्/अव्/आय्/आव् before a vowel — ए, ओ, ऐ, औ विभक्त हो जाते हैं","अ/आ upgrades the following vowel","ik vowels become semi-vowels"],answer:"ec vowels (ए, ओ, ऐ, औ) dissolve into अय्/अव्/आय्/आव् before a vowel — ए, ओ, ऐ, औ विभक्त हो जाते हैं",explanation:"एचः = of the 'ec' vowels (ए, ओ, ऐ, औ); they become अय्, अव्, आय्, आव् before another vowel. Each compound vowel splits back into its two parts with a semi-vowel bridge."},
  {type:"mcq",question:"ए + (vowel) = ?",instruction:"ए + (कोई स्वर) का सन्धि परिणाम चुनें।",options:["ए + vowel unchanged","अय् + vowel","आय् + vowel","अव् + vowel"],answer:"अय् + vowel",explanation:"ए before any vowel dissolves into अय् by अयादि सन्धि. Example: ने + अन → न + अय् + अन = नयन (eye)."},
  {type:"mcq",question:"ने + अन = ?",instruction:"ने + अनका सन्धि रूप चुनें।",options:["नेअन","नेन","नयन","नान"],answer:"नयन",explanation:"ने ends in ए; अन begins with अ. ए → अय् before अ: न + अय् + अन = नयन (eye)."},
  {type:"mcq",question:"औ + (vowel) = ?",instruction:"औ + (कोई स्वर) का सन्धि परिणाम चुनें।",options:["औ + vowel unchanged","अय् + vowel","आव् + vowel","अव् + vowel"],answer:"आव् + vowel",explanation:"औ before any vowel dissolves into आव् by अयादि सन्धि. Example: नौ + इक → न + आव् + इक = नाविक (sailor)."},
