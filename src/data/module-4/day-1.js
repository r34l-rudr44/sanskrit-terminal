...
export const questions = [
  {type:"mcq",question:"\"अकः सवर्णे दीर्घः\" means:",instruction:"इस सूत्रका अर्थ चुनें।",options:["Two different vowels create a new sound","Two similar vowels fuse into one long vowel — सवर्ण स्वर मिलकर दीर्घ बनते हैं","A consonant lengthens the next vowel","Vowels disappear at word boundaries"],answer:"Two similar vowels fuse into one long vowel — सवर्ण स्वर मिलकर दीर्घ बनते हैं",explanation:"अकः = from the 'ak' set (अ, इ, उ, ऋ); सवर्णे = when followed by a similar vowel; दीर्घः = becomes long. The rule covers all four vowel pairs at once."},
  {type:"mcq",question:"अ + आ = ?",instruction:"अ + आ का सन्धि परिणाम चुनें।",options:["अ","ऐ","अआ","आ"],answer:"आ",explanation:"अ + आ → आ by दीर्घ सन्धि. Example: हिम (ends in अ) + आलय (begins with आ) = हिमालय. The boundary अ+आ fuses into one long आ."},
  {type:"mcq",question:"हिम + आलय = ?",instruction:"हिम + आलयका सन्धि रूप चुनें।",options:["हिमेलय","हिमाँलय","हिमाआलय","हिमालय"],answer:"हिमालय",explanation:"हिम ends in अ; आलय begins with आ. अ + आ → आ: the boundary fuses into a single long आ, giving हिमालय (Himalaya)."},
  ...
  {type:"mcq",question:"रवि + इन्द्र = ?",instruction:"रवि + इन्द्रका सन्धि रूप चुनें।",options:["रविइन्द्र","रवेन्द्र","रविन्द्र","रवीन्द्र"],answer:"रवीन्द्र",explanation:"रवि ends in इ; इन्द्र begins with इ. इ + इ → ई: the boundary double-इ fuses into one long ई, giving रवीन्द्र (Rabindra/Ravindra)."},
