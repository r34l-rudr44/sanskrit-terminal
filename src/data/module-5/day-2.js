...
export const questions = [
  {type:"mcq",question:"कति means:",instruction:"कति शब्दका अनुवाद करें।",options:["When कब","How many कितने","How कैसे","From where कहाँ से"],answer:"How many कितने",explanation:"कति = How many? (कितने?) — asks about quantity or number."},
  {type:"mcq",question:"कुतः means:",instruction:"कुतः शब्दका अनुवाद करें।",options:["Where कहाँ","From where कहाँ से","How कैसे","Why क्यों"],answer:"From where कहाँ से",explanation:"कुतः = From where? (कहाँ से?) — asks about origin or starting point. Contrast: कुत्र = Where? (location or destination)."},
  {type:"mcq",question:"कथम् त्वं गच्छसि। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["When do you go?","Why do you go?","How do you go? — तुम कैसे जाते हो?","Where do you go?"],answer:"How do you go? — तुम कैसे जाते हो?",explanation:"कथम् = How? (कैसे?). कथम् त्वं गच्छसि = How do you go? (तुम कैसे जाते हो?)"},
  {type:"mcq",question:"किमर्थम् means:",instruction:"किमर्थम् शब्दका अनुवाद करें।",options:["What? क्या","When? कब","How? कैसे","Why? क्यों"],answer:"Why? क्यों",explanation:"किमर्थम् = Why? (क्यों?) — literally 'for what purpose?'. किम् (what) + अर्थम् (for the sake of) = किमर्थम्."},
