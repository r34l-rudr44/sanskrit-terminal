...
export const questions = [
  {type:"mcq",question:"एकदा means:",instruction:"एकदा शब्दका अनुवाद करें।",options:["Many times कई बार","Once एक बार","Always हमेशा","At another time किसी और समय"],answer:"Once एक बार",explanation:"एकदा = Once (एक बार). एक (one) + दा → एकदा. Compare: अनेकदा (many times), शतदा (hundred times)."},
  {type:"mcq",question:"Which word means 'at another time — किसी अन्य समय'?",instruction:"किसी अन्य समय शब्दको संस्कृतमें लिखें।",options:["एकदा","नित्यदा","अन्यदा","शतदा"],answer:"अन्यदा",explanation:"अन्यदा = at another time (किसी अन्य समय). अन्य (other) + दा → अन्यदा."},
  {type:"mcq",question:"शतदा means:",instruction:"शतदा शब्दका अनुवाद करें।",options:["Once","A hundred times सौ बार","Always","Daily"],answer:"A hundred times सौ बार",explanation:"शतदा = a hundred times (सौ बार). शत (hundred) + दा → शतदा. Used to express intense repetition."},
  ...
  {type:"mcq",question:"'Come at another time' is:",instruction:"'किसी और समय आओ' का संस्कृतमें अनुवाद करें।",options:["एकदा आगच्छ","नित्यदा आगच्छ","अन्यदा आगच्छ","शतदा आगच्छ"],answer:"अन्यदा आगच्छ",explanation:"अन्यदा आगच्छ = Come at another time (किसी और समय आओ). अन्यदा = at another time."}
];
