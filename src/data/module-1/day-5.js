...
export const questions = [
  {type:"mcq",question:"कः means:",instruction:"कः शब्दका अनुवाद करें।",options:["Where कहाँ","Who? कौन","What? क्या","There वहाँ"],answer:"Who? कौन",explanation:"कः = Who? (कौन) — used for masculine subjects. It is the interrogative pronoun for 'who'."},
  {type:"mcq",question:"कः तत्र गच्छति। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["Who is there?","Who goes there? — कौन वहाँ जाता है?","He goes there","Does he go there?"],answer:"Who goes there? — कौन वहाँ जाता है?",explanation:"कः तत्र गच्छति = Who goes there? (कौन वहाँ जाता है?) — कः (who) + तत्र (there) + गच्छति (goes)."},
  ...
  {type:"fill",question:"Complete: ___ तत्र अस्ति (Who is there?)",sentenceParts:["", " तत्र अस्ति।"],answer:"कः",answerRoman:"kaH",translation:"Who is there?",explanation:"कः तत्र अस्ति = Who is there? (कौन वहाँ है?) — कः starts the question."},
  ...
  {type:"mcq",question:"कः तत्र अस्ति किम्। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["Who goes there?","He is there","Is someone there? — क्या वहाँ कोई है?","Who does not go?"],answer:"Is someone there? — क्या वहाँ कोई है?",explanation:"कः तत्र अस्ति किम् = Is someone there? (क्या वहाँ कोई है?) — किम् at the end turns it into a yes/no question."},
  {type:"mcq",question:"तत्र कः न गच्छति। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["Who is everywhere?","Who does not go there? — वहाँ कौन नहीं जाता?","He does not go","Where does he go?"],answer:"Who does not go there? — वहाँ कौन नहीं जाता?",explanation:"तत्र कः न गच्छति = Who does not go there? (वहाँ कौन नहीं जाता?) — combines तत्र, कः, न, and गच्छति."}
];
