...
export const questions = [
  {type:"mcq",question:"कुत्र means:",instruction:"कुत्र शब्दका अनुवाद करें।",options:["Here यहाँ","There वहाँ","Where? कहाँ","Everywhere सब स्थान पर"],answer:"Where? कहाँ",explanation:"कुत्र = Where? (कहाँ) — an interrogative adverb for location."},
  {type:"mcq",question:"Which word means 'Here'?",instruction:"यहाँ शब्दको संस्कृतमें लिखें।",options:["तत्र","यत्र","सर्वत्र","अत्र"],answer:"अत्र",explanation:"अत्र = Here (यहाँ). तत्र = There (वहाँ), यत्र = Where (जहाँ), सर्वत्र = Everywhere (सब स्थान पर)."},
  ...
  {type:"mcq",question:"त्वं कुत्र गच्छसि। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["Where do you go? — तुम कहाँ जाते हो?","I go there — मैं वहाँ जाता हूँ","He goes here — वह यहाँ जाता है","You go everywhere — तुम सब स्थान पर जाते हो"],answer:"Where do you go? — तुम कहाँ जाते हो?",explanation:"त्वं कुत्र गच्छसि = Where do you go? (तुम कहाँ जाते हो?) — pronoun + location word + verb."},
  {type:"mcq",question:"एकत्र means:",instruction:"एकत्र शब्दका अनुवाद करें।",options:["Everywhere सब स्थान पर","Somewhere else कहीं और","Where? कहाँ","At one place एक स्थान पर"],answer:"At one place एक स्थान पर",explanation:"एकत्र = At one place (एक स्थान पर). एक = one, -त्र = place."},
  {type:"mcq",question:"सर्वत्र means:",instruction:"सर्वत्र शब्दका अनुवाद करें।",options:["Somewhere else कहीं और","At one place एक स्थान पर","Everywhere सब स्थान पर","Where? कहाँ"],answer:"Everywhere सब स्थान पर",explanation:"सर्वत्र = Everywhere (सब स्थान पर). सर्व = all/every, -त्र = place."},
  {type:"mcq",question:"यत्र सः गच्छति तत्र अहम्। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["He goes everywhere — वह सब स्थान पर जाता है","Where he goes, there I go too — जहाँ वह जाता है वहाँ मैं","Where do I go? — मैं कहाँ जाता हूँ?","I go there — मैं वहाँ जाता हूँ"],answer:"Where he goes, there I go too — जहाँ वह जाता है वहाँ मैं",explanation:"यत्र...तत्र is a correlative pair meaning 'where...there'. यत्र सः गच्छति = where he goes; तत्र अहम् = there I (go too)."},
  {type:"mcq",question:"किं सः गच्छति। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["He goes everywhere — वह सब स्थान पर जाता है","Where does he go? — वह कहाँ जाता है?","Does he go? — क्या वह जाता है?","He does not go — वह नहीं जाता"],answer:"Does he go? — क्या वह जाता है?",explanation:"किम् at the start of a sentence creates a yes/no question. किं सः गच्छति = Does he go? (क्या वह जाता है?)"}
];
