...
export const questions = [
  {type:"mcq",question:"न means:",instruction:"न शब्दका अनुवाद करें।",options:["Not / No नहीं","There वहाँ","Where कहाँ","Is है"],answer:"Not / No नहीं",explanation:"न = not/no (नहीं). It is placed before the verb to negate any sentence."},
  {type:"mcq",question:"अहं न गच्छामि। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["I go","I do not go — मैं नहीं जाता","He does not go","You do not go"],answer:"I do not go — मैं नहीं जाता",explanation:"अहं न गच्छामि = I do not go (मैं नहीं जाता). न before गच्छामि negates the first-person verb."},
  ...
  {type:"mcq",question:"How do you say 'He does not go'?",instruction:"'वह नहीं जाता' का संस्कृतमें अनुवाद करें।",options:["सः गच्छति।","सः न गच्छति।","अहं न गच्छामि।","त्वं न गच्छसि।"],answer:"सः न गच्छति।",explanation:"सः न गच्छति = He does not go. न is placed before गच्छति (the third-person verb)."},
  ...
  {type:"mcq",question:"त्वं न गच्छसि किम्। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["You go everywhere","Do you not go? — तुम नहीं जाते क्या?","He does not go","You do not go here"],answer:"Do you not go? — तुम नहीं जाते क्या?",explanation:"किम् added to त्वं न गच्छसि turns it into a question: Do you not go? (तुम नहीं जाते क्या?)"},
  {type:"mcq",question:"नास्ति is a contraction of:",instruction:"नास्ति शब्दका सन्धि-विच्छेद करें।",options:["न + गच्छति","न + सः","न + अस्ति","न + तत्र"],answer:"न + अस्ति",explanation:"नास्ति = न + अस्ति. Just as 'isn't' = 'is not' in English, नास्ति is the ready-made negation of अस्ति (is)."}
];
