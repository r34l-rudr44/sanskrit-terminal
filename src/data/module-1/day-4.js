...
export const questions = [
  ...
  {type:"fill",question:"Negate the sentence: त्वं सर्वत्र ___ गच्छसि (You do not go everywhere)",sentenceParts:["त्वं सर्वत्र "," गच्छसि"],answer:"न",answerRoman:"na",explanation:"त्वं सर्वत्र न गच्छसि = You do not go everywhere. न goes before the verb गच्छसि."},
  {type:"wordtiles",question:"Build the sentence: 'I do not go there'",tiles:["अहं","तत्र","न","गच्छामि"],distractors:["गच्छसि","सः"],answer:"अहं तत्र न गच्छामि",explanation:"अहं तत्र न गच्छामि = I do not go there. Word order: pronoun → place → न → verb."},
