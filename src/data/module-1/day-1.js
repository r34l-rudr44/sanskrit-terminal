...
export const questions = [
  {type:"mcq",question:"What does सः mean? सः शब्दका अनुवाद करें।",options:["He वह (पुं)","She वह (स्त्री)","It वो (नपुं)","You तुम"],answer:"He वह (पुं)",explanation:"सः = He (वह). The masculine third-person pronoun."},
  {type:"mcq",question:"Which Sanskrit word means 'I'? मैं शब्दको संस्कृतमें लिखें।",options:["सः","सा","त्वम्","अहम्"],answer:"अहम्",explanation:"अहम् = I (मैं). Also written अहं. First-person singular."},
  {type:"mcq",question:"तत् refers to? तत् शब्दका अनुवाद करें।",options:["He वह (पुं)","She वह (स्त्री)","It वो (नपुं)","You तुम"],answer:"It वो (नपुं)",explanation:"तत् = It (वो). The neuter pronoun, used for things that are neither masculine nor feminine."},
  ...
  {type:"mcq",question:"त्वम् translates to: त्वम् शब्दका अनुवाद करें।",options:["I मैं","He वह (पुं)","She वह (स्त्री)","You तुम"],answer:"You तुम",explanation:"त्वम् = You (तुम). Second-person singular. Also written त्वं."},
  {type:"mcq",question:"Which pronoun is feminine? निम्नलिखितमें से स्त्रीलिङ्गी सर्वनाम शब्दको चुनें।",options:["सः","तत्","त्वम्","सा"],answer:"सा",explanation:"सा = She (वह स्त्री.). सः is masculine — He (वह), तत् is neuter — It (वो)."},
  {type:"mcq",question:"Which pronoun is neuter — neither masculine nor feminine? निम्नलिखितमें से नपुंसकलिङ्गी सर्वनाम शब्दको चुनें।",options:["सः","सा","त्वम्","तत्"],answer:"तत्",explanation:"तत् = It (वो) — the neuter pronoun. सः (He) is masculine, सा (She) is feminine. त्वम् and अहम् cover all genders."}
];
