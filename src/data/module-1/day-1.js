...
export const questions = [
  {type:"mcq",question:"What does सः mean?",options:["He — वह (पुं)","She — वह (स्त्री)","It — वो (नपुं)","You — तुम"],answer:"He — वह (पुं)",explanation:"सः = He (वह). The masculine third-person pronoun."},
  ...
  {type:"mcq",question:"तत् refers to:",options:["He — वह (पुं)","She — वह (स्त्री)","It — वो (नपुं)","You — तुम"],answer:"It — वो (नपुं)",explanation:"तत् = It (वो). The neuter pronoun, used for things that are neither masculine nor feminine."},
  ...
  {type:"mcq",question:"त्वम् translates to:",options:["I — मैं","He — वह (पुं)","She — वह (स्त्री)","You — तुम"],answer:"You — तुम",explanation:"त्वम् = You (तुम). Second-person singular. Also written त्वं."},
