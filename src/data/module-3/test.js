...
export const metadata = {
  ...
  grammarTopics: ["temporal-adverbs", "future-tense", "correlatives", "frequency"],
  vocabularyTopics: ["time", "frequency", "conditionals"]
};

export const briefing = {
  pre: {
    title: "Module 3 Final Test",
    lead: "You've covered time words (कदा, यदा, सदा, तदा), time of day, the full correlative family (यदा…तदा, यदि…तर्हि, यथा…तथा), the future tense (गमिष्यामि), and frequency adverbs (एकदा, नित्यदा). This test brings it all together.",
    sections: [
      { type:"block", text:"<strong>This test covers:</strong> -दा time words · time of day · future tense · correlative pairs · frequency adverbs" },
...
export const questions = [
  ...
  {type:"mcq",question:"एकदा means:",options:["Many times — कई बार","A hundred times — सौ बार","Always — हमेशा","Once — एक बार"],answer:"Once — एक बार",explanation:"एकदा = once (एक बार). एक (one) + दा → एकदा. Compare: अनेकदा (many times), शतदा (hundred times), नित्यदा (daily)."},
