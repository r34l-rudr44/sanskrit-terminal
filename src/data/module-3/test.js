...
export const questions = [
  {type:"mcq",question:"कदा means:",instruction:"कदा शब्दका अनुवाद करें।",options:["Always हमेशा","Then तब","When? कब","Where? कहाँ"],answer:"When? कब",explanation:"कदा = When? (कब). The कु- prefix marks the interrogative: कदा (when?), कुत्र (where?)."},
  {type:"mcq",question:"Which pair expresses 'when…then'?",instruction:"'जब...तब' अर्थ वाला शब्द-युग्म चुनें।",options:["यत्र...तत्र","यदि...तर्हि","यदा...तदा","यथा...तथा"],answer:"यदा...तदा",explanation:"यदा...तदा = when...then (जब...तब). यत्र...तत्र = where...there; यदि...तर्हि = if...then; यथा...तथा = just as...so too."},
  {type:"mcq",question:"प्रातः means:",instruction:"प्रातः शब्दका अनुवाद करें।",options:["In the evening","At night","At noon","In the morning प्रातःकाल"],answer:"In the morning प्रातःकाल",explanation:"प्रातः = in the morning. Time of day: प्रातः (morning) → दिवा (day) → मध्याह्ने (noon) → सायम् (evening) → रात्रौ (night)."},
  ...
  {type:"mcq",question:"गमिष्यति means:",instruction:"गमिष्यति शब्दका अनुवाद करें।",options:["He is going वह जाता है","He went वह गया","He will go वह जाएगा","He does not go वह नहीं जाता"],answer:"He will go वह जाएगा",explanation:"गमिष्यति = He/she will go (वह जाएगा). Future infix -इष्य-: गमिष्यामि (I), गमिष्यसि (you), गमिष्यति (he/she)."},
  ...
  {type:"mcq",question:"यथा...तथा expresses:",instruction:"यथा...तथा शब्द-युग्मका सही अर्थ चुनें।",options:["A time sequence — when...then","A place — where...there","A condition — if...then","A comparison — just as...so too"],answer:"A comparison — just as...so too",explanation:"यथा...तथा = just as...so too (जैसे...वैसे). यथा सः गच्छति तथा त्वं गमिष्यसि = Just as he goes, so will you go."},
