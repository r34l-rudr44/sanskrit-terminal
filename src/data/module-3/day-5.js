...
export const questions = [
  {type:"mcq",question:"यदि means:",instruction:"यदि शब्दका अनुवाद करें।",options:["When जब","Always हमेशा","How कैसे","If अगर"],answer:"If अगर",explanation:"यदि = If (अगर). It opens a conditional clause and pairs with तर्हि (then). यदि...तर्हि = if...then — the condition correlative pair."},
  {type:"mcq",question:"तर्हि means:",instruction:"तर्हि शब्दका अनुवाद करें।",options:["Just as जैसे","Where जहाँ","Then (in that case) तब","When जब"],answer:"Then (in that case) तब",explanation:"तर्हि = Then / in that case (तब, उस स्थिति में). It is the result-half of यदि...तर्हि, parallel to तदा in यदा...तदा and तत्र in यत्र...तत्र."},
  {type:"mcq",question:"यथा...तथा expresses:",instruction:"यथा...तथा शब्द-युग्मका सही अर्थ चुनें।",options:["If...then — a condition","When...then — a time sequence","Where...there — a place correlation","Just as...so too — a comparison"],answer:"Just as...so too — a comparison",explanation:"यथा...तथा = 'just as...so too'. यथा सः गच्छति तथा त्वं गमिष्यसि = Just as he goes, so will you go. The whole य-/त- family: यत्र/तत्र (place), यदा/तदा (time), यदि/तर्हि (condition), यथा/तथा (comparison)."},
