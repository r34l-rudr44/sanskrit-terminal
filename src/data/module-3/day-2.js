...
export const questions = [
  {type:"mcq",question:"यदा सः ग्रामं गच्छति। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["He always goes to the village","When does he go to the village?","When he goes to the village — जब वह गाँव जाता है","He does not go to the village"],answer:"When he goes to the village — जब वह गाँव जाता है",explanation:"यदा introduces a relative time clause — 'when (something happens)'. यदा सः ग्रामं गच्छति = When he goes to the village (जब वह गाँव जाता है)."},
  ...
  {type:"mcq",question:"सः उद्यानं सर्वदा न गच्छति। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["He always goes to the garden","He does not go to the garden","He does not always go to the garden — वह बाग हमेशा नहीं जाता","He never goes anywhere"],answer:"He does not always go to the garden — वह बाग हमेशा नहीं जाता",explanation:"सर्वदा न = 'not always' (partial negation). सः उद्यानं सर्वदा न गच्छति = He does not always go to the garden — sometimes he does, just not every time."},
