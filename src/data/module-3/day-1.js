...
export const questions = [
  {type:"mcq",question:"कदा means:",instruction:"कदा शब्दका अनुवाद करें।",options:["Then तब","Always हमेशा","When? कब","Where? कहाँ"],answer:"When? कब",explanation:"कदा = When? (कब) — interrogative time adverb. The कु- prefix marks questions: कदा = when?, कुत्र = where?"},
  {type:"mcq",question:"Which word means 'Then'?",instruction:"तब शब्दको संस्कृतमें लिखें।",options:["सदा","यदा","कदा","तदा"],answer:"तदा",explanation:"तदा = Then (तब). The त- prefix points to something: तदा = then, तत्र = there."},
  ...
  {type:"mcq",question:"सः सदा उद्यानं गच्छति। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["He sometimes goes to the garden","He never goes to the garden","He always goes to the garden — वह हमेशा बाग जाता है","He will go to the garden"],answer:"He always goes to the garden — वह हमेशा बाग जाता है",explanation:"सः सदा उद्यानं गच्छति = He always goes to the garden (वह हमेशा बाग जाता है). सदा = always (हमेशा). You may also see सर्वदा and सदैव with the same meaning."},
  {type:"mcq",question:"कदा सः नगरं गच्छति। means:",instruction:"इस वाक्यका अनुवाद करें।",options:["He always goes to the city","When does he go to the city? — कब वह नगर जाता है?","He does not go to the city","Does he go to the city?"],answer:"When does he go to the city? — कब वह नगर जाता है?",explanation:"कदा at the start makes a 'when' question. कदा सः नगरं गच्छति = When does he go to the city? (कब वह नगर जाता है?)"},
